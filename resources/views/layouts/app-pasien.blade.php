                            ...
                            <div class="menu menu-column menu-rounded menu-sub-indention fw-semibold px-1"
                                ...
                                <div data-kt-menu-trigger="click" class="menu-item menu-accordion show">
                                    <span class="menu-link">
                                        ...
                                        <span class="menu-title">Konsultasi dengan Dokter</span>
                        ...
                        <div class="">
                            <div class="d-flex align-items-center"
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <a href="" class="fw-semibold text-muted text-hover-primary fs-7">No.
                                        RM:
                                        {{ Auth::user()->pasien->nrm }}</a>
                                </div>
                            </div>
                ...
                <div id="kt_app_footer" class="app-footer">
                    <div
                        ...
                        <div class="text-dark order-2 order-md-1">
                            ...
                            <a href="{{ route('dashboard.pasien') }}" target="_blank"
