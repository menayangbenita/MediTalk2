    ...
    <div class="d-flex flex-column flex-root" id="kt_app_root">
        ...
        <div class="d-flex flex-column flex-lg-row flex-column-fluid">
              ...
              <a href="{{ route('login') }}" class="link-primary fw-bold fs-5" data-kt-translate="sign-up-head-link">Masuk sekarang!</a>
                    ...
                    <div class="py-20">
                        ...
                        <form class="form w-100" novalidate="novalidate" id="kt_sign_up_form" data-kt-redirect-url=""
                            ...
                            <div class="text-start mb-10">
                                ...
                                <!--end::Title-->
                                <!--begin::Text-->
                                <div class="text-gray-400 fw-semibold fs-6" data-kt-translate="general-desc">Konsultasi
                                    Online bersama Dokter Profesional!</div>
                                <!--end::Link-->
                            </div>
                            <!--end::Heading-->
                            <!--begin::Input group-->
                            ...
                            <div class="fv-row mb-7" data-kt-password-meter="true">
                                ...
                                <div class="mb-1">
                                    ...
                                    <div class="position-relative mb-3">
                                        <input class="form-control form-control-lg form-control-solid" type="password"
                                            placeholder="Buat kata sandi" name="password" autocomplete="off"
                                ...
                                <!--end::Wrapper-->
                                <!--begin::Hint-->
                                <div class="text-muted" data-kt-translate="sign-up-hint">Gunakan 8 karakter atau lebih
                                    dengan kombinasi huruf, angka, dan simbol.</div>
                                <!--end::Hint-->
                            </div>
                            <!--end::Input group=-->
                            <!--begin::Input group-->
                            <div class="fv-row mb-10">
                                <input class="form-control form-control-lg form-control-solid" type="password"
                                    ...
                                    autocomplete="off" data-kt-translate="sign-up-input-confirm-password" />
                            </div>
                            <!--end::Input group-->
                            <!--begin::Actions-->
                            <div class="d-flex flex-stack">
                                <!--begin::Submit-->
                                <button id="kt_sign_up_submit" class="btn btn-primary w-100" type="submit"
                  ...
                  <div class="text-gray-400 fw-semibold fs-6 me-6">Or</div>
                        ...
                        <div class="mt-10 text-center">
                            <span class="text-gray-400 fw-bold fs-5 me-2" data-kt-translate="sign-up-head-desc">Sudah
                                memiliki akun?</span>
                            <a href="{{ route('login') }}" class="link-primary fw-bold fs-5"
                                data-kt-translate="sign-up-head-link">Masuk sekarang!</a>
                        </div>
                    </div>
                    <!--end::Body-->
                    <!--begin::Footer-->
            ...
            <div class="d-none d-lg-flex flex-lg-row-fluid w-50 bgi-size-cover bgi-position-y-center bgi-position-x-start bgi-no-repeat register-page"
                style="background-image: url('{{ asset('media/auth/register.jpg') }}')"></div>
            <!--begin::Body-->
        </div>
